...
struct ProfileView: View {
    ...
    // Here they match the wireframe values exactly.
    ...
    private var avatarSection: some View {
        VStack(spacing: 10) {
            ...
            ZStack(alignment: .bottomTrailing) {
                ...
                // Replace with Image("profile_photo") when using a real photo.
    ...
    // Generic card container used in the stats row.
    //Takes a background colour and any content via @ViewBuilder.
    ...
    // Streak pill badge
    // Green rounded rectangle with flame icon and "STREAK" text.
