...
struct SignUpView: View {
    ...
    //Controls whether the form has been submitted.
    // Set to true when "Get Started" is tapped, triggering navigation.
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                //  Invisible NavigationLink for programmatic nav
                NavigationLink(
                    destination: SetGoalView(userName: fullName).navigationBarBackButtonHidden(true),
