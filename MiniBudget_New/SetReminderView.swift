...
struct SetReminderView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            // The DatePicker wheel-style is used inline
            timePicker
                .padding(.horizontal, 24)
                .padding(.bottom, 28)
            ...
            // Invisible programmatic navigation link
            NavigationLink(
    ...
    //Grey back arrow button using SF Symbols
    ...
    // Daily / Weekly segmented toggle — two chips side by side
    ...
    private var pushNotificationRow: some View {
        HStack(spacing: 14) {
            ...
            // iOS-style toggle — tint matches brand green
