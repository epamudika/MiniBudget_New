...
struct RewardsView: View {
    ...
    // Progress header
    // "MONTHLY PROGRESS" small label
    // "3 Badges left to unlock this Month" headline
    // Green progress bar + "Total Badges: 3" label
    private var progressHeader: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            // "Total Badges: 3" label aligned to right
            HStack {
                Spacer()
...
struct BadgeCard: View {
    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            // Locked pill label (only shown for locked badges)
            if !badge.isEarned {
                Text("LOCKED")
