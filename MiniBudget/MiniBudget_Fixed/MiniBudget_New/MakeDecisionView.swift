...
struct MakeDecisionView: View {
    ...
    private func saveAndNavigate() {
        ...
        //Fire "Money Saved" notification (impulse avoided)
    ...
    // Unlock a single badge by type string 
    @discardableResult
