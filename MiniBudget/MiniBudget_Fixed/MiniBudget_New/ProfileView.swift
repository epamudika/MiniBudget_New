...
struct ProfileView: View {
    ...
    // Computed: real values from CoreData
    ...
    // Real member since from CoreData startDate
    ...
    // Best day of week computed from real savings entries
    ...
    // Real weekly activity from CoreData (last 7 days)
